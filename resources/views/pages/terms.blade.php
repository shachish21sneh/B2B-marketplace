...
@section('content')
    ...
    <div class="max-w-4xl mx-auto px-4 py-12">
        <div class="bg-white rounded-3xl border border-slate-200 p-8 sm:p-12 shadow-sm space-y-6 text-xs text-slate-600 leading-relaxed">
            <h1 class="text-2xl font-extrabold font-heading text-slate-900">Terms of Service & Commercial Conditions</h1>
            ...
            <h2 class="text-sm font-bold text-slate-900 mt-4">3. Quotations & Contracts</h2>
            <p>Quotations submitted on the platform represent commercial bids. Final sales contracts, letters of credit (LC), and delivery arrangements are negotiated directly between buyers and sellers.</p>
        </div>
    </div>
